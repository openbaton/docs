EMS(Element Management System) is a tool that is needed in order to process and issue the command on behalf of the orchestrator. It take the messages in json format
